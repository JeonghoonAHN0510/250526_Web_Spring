...
public class PostService {
    ...
    // [2] 게시물 전체조회(페이징처리)
    // cno : 카테고리 번호, page : 현재 페이지번호, count : 페이지당 자료 개수
